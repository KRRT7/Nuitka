...
""" % {
    ...
    if Options.shallMakeModule() and Options.shallCreatePyiFile():
        ...
        # stubgen = importFromInlineCopy("Ast_Stubgen", must_exist=True)
        stubgen = importFromInlineCopy("stubgen", must_exist=True)
        pyi_filename = OutputDirectories.getResultBasePath() + ".pyi"
        contents = """# This file was generated by Nuitka and generates the type stubs of the
