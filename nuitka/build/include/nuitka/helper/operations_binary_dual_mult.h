 ...
 */
extern bool BINARY_OPERATION_MULT_NILONG_NILONG_NILONG(nuitka_ilong *result, nuitka_ilong *operand1,
 ...
 * Python objects. */
extern bool BINARY_OPERATION_MULT_NILONG_NILONG_DIGIT(nuitka_ilong *result, nuitka_ilong *operand1, long operand2);
