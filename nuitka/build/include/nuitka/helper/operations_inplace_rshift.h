 ...
 * Python objects. */
extern bool INPLACE_OPERATION_RSHIFT_LONG_DIGIT(PyObject **operand1, long operand2);

/* Code referring to "LONG" corresponds to Python2 'long', Python3 'int' and "CLONG" to C platform long value. */
extern bool INPLACE_OPERATION_RSHIFT_LONG_CLONG(PyObject **operand1, long operand2);
