 ...
 * Python objects. */
extern PyObject *BINARY_OPERATION_BITOR_OBJECT_LONG_DIGIT(PyObject *operand1, long operand2);

/* Code referring to "LONG" corresponds to Python2 'long', Python3 'int' and "DIGIT" to C platform digit value for long
 * Python objects. */
extern nuitka_bool BINARY_OPERATION_BITOR_NBOOL_LONG_DIGIT(PyObject *operand1, long operand2);

/* Code referring to "LONG" corresponds to Python2 'long', Python3 'int' and "CLONG" to C platform long value. */
extern PyObject *BINARY_OPERATION_BITOR_OBJECT_LONG_CLONG(PyObject *operand1, long operand2);

/* Code referring to "LONG" corresponds to Python2 'long', Python3 'int' and "CLONG" to C platform long value. */
extern nuitka_bool BINARY_OPERATION_BITOR_NBOOL_LONG_CLONG(PyObject *operand1, long operand2);
