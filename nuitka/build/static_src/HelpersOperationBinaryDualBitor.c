 ...
 */
bool BINARY_OPERATION_BITOR_NILONG_NILONG_NILONG(nuitka_ilong *result, nuitka_ilong *operand1, nuitka_ilong *operand2) {
...
#pragma warning(pop)
    ...
    exit_result_ok_clong:
        ...
        PyObject *python_result = BINARY_OPERATION_BITOR_OBJECT_LONG_CLONG(operand1->python_value, operand2->c_value);
        ...
        PyObject *python_result = BINARY_OPERATION_BITOR_OBJECT_LONG_CLONG(operand2->python_value, operand1->c_value);
        ...
        PyObject *python_result =
            BINARY_OPERATION_BITOR_OBJECT_LONG_LONG(operand1->python_value, operand2->python_value);
 ...
 * Python objects. */
bool BINARY_OPERATION_BITOR_NILONG_NILONG_DIGIT(nuitka_ilong *result, nuitka_ilong *operand1, long operand2) {
    CHECK_NILONG_OBJECT(operand1);
...
#pragma warning(pop)
    ...
    exit_result_ok_clong:
        ...
        PyObject *python_result = BINARY_OPERATION_BITOR_OBJECT_LONG_DIGIT(operand1->python_value, operand2);
