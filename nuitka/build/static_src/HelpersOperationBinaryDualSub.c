...
#pragma warning(pop)
        ...
        obj_result = BINARY_OPERATION_SUB_OBJECT_OBJECT_OBJECT(operand1->python_value, operand2_object);
    ...
    exit_result_ok_clong:
        ...
        PyObject *operand2_object = Nuitka_PyLong_FromLong(operand2->c_value);
        PyObject *python_result = BINARY_OPERATION_SUB_OBJECT_OBJECT_OBJECT(operand1->python_value, operand2_object);
        Py_DECREF(operand2_object);
        ...
        *result = Nuitka_NILONG_FromObject(python_result);
        ...
        PyObject *python_result = BINARY_OPERATION_SUB_OBJECT_OBJECT_OBJECT(operand1_object, operand2->python_value);
        ...
        *result = Nuitka_NILONG_FromObject(python_result);
        ...
        PyObject *python_result =
            BINARY_OPERATION_SUB_OBJECT_OBJECT_OBJECT(operand1->python_value, operand2->python_value);
...
#pragma warning(pop)
        ...
        obj_result = BINARY_OPERATION_SUB_OBJECT_OBJECT_OBJECT(operand1_object, operand2->python_value);
        Py_DECREF(operand1_object);
