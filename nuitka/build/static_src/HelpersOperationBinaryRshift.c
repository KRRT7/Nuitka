...
#pragma warning(pop)
    ...
    PyObject *x = PyLong_Type.tp_as_number->nb_rshift(operand1_object, operand2_object);
 ...
 * Python objects. */
static PyObject *_BINARY_OPERATION_RSHIFT_OBJECT_LONG_DIGIT(PyObject *operand1, long operand2) {
    CHECK_OBJECT(operand1);
    assert(PyLong_CheckExact(operand1));
...
PyObject *BINARY_OPERATION_RSHIFT_OBJECT_LONG_DIGIT(PyObject *operand1, long operand2) {
    return _BINARY_OPERATION_RSHIFT_OBJECT_LONG_DIGIT(operand1, operand2);
}

/* Code referring to "DIGIT" corresponds to C platform digit value for long Python objects and "LONG" to Python2 'long',
 * Python3 'int'. */
static PyObject *_BINARY_OPERATION_RSHIFT_OBJECT_DIGIT_LONG(long operand1, PyObject *operand2) {
...
PyObject *BINARY_OPERATION_RSHIFT_OBJECT_DIGIT_LONG(long operand1, PyObject *operand2) {
    return _BINARY_OPERATION_RSHIFT_OBJECT_DIGIT_LONG(operand1, operand2);
}

/* Code referring to "LONG" corresponds to Python2 'long', Python3 'int' and "DIGIT" to C platform digit value for long
 * Python objects. */
static nuitka_bool _BINARY_OPERATION_RSHIFT_NBOOL_LONG_DIGIT(PyObject *operand1, long operand2) {
    CHECK_OBJECT(operand1);
    assert(PyLong_CheckExact(operand1));
    assert(Py_ABS(operand2) < (1 << PyLong_SHIFT));
...
nuitka_bool BINARY_OPERATION_RSHIFT_NBOOL_LONG_DIGIT(PyObject *operand1, long operand2) {
    return _BINARY_OPERATION_RSHIFT_NBOOL_LONG_DIGIT(operand1, operand2);
}

/* Code referring to "DIGIT" corresponds to C platform digit value for long Python objects and "LONG" to Python2 'long',
 * Python3 'int'. */
static nuitka_bool _BINARY_OPERATION_RSHIFT_NBOOL_DIGIT_LONG(long operand1, PyObject *operand2) {
    assert(Py_ABS(operand1) < (1 << PyLong_SHIFT));
    CHECK_OBJECT(operand2);
    assert(PyLong_CheckExact(operand2));
...
nuitka_bool BINARY_OPERATION_RSHIFT_NBOOL_DIGIT_LONG(long operand1, PyObject *operand2) {
    return _BINARY_OPERATION_RSHIFT_NBOOL_DIGIT_LONG(operand1, operand2);
}

/* Code referring to "LONG" corresponds to Python2 'long', Python3 'int' and "CLONG" to C platform long value. */
static PyObject *_BINARY_OPERATION_RSHIFT_OBJECT_LONG_CLONG(PyObject *operand1, long operand2) {
    CHECK_OBJECT(operand1);
    assert(PyLong_CheckExact(operand1));
...
PyObject *BINARY_OPERATION_RSHIFT_OBJECT_LONG_CLONG(PyObject *operand1, long operand2) {
    return _BINARY_OPERATION_RSHIFT_OBJECT_LONG_CLONG(operand1, operand2);
}

/* Code referring to "CLONG" corresponds to C platform long value and "LONG" to Python2 'long', Python3 'int'. */
static PyObject *_BINARY_OPERATION_RSHIFT_OBJECT_CLONG_LONG(long operand1, PyObject *operand2) {
...
PyObject *BINARY_OPERATION_RSHIFT_OBJECT_CLONG_LONG(long operand1, PyObject *operand2) {
    return _BINARY_OPERATION_RSHIFT_OBJECT_CLONG_LONG(operand1, operand2);
}

/* Code referring to "LONG" corresponds to Python2 'long', Python3 'int' and "CLONG" to C platform long value. */
static nuitka_bool _BINARY_OPERATION_RSHIFT_NBOOL_LONG_CLONG(PyObject *operand1, long operand2) {
    CHECK_OBJECT(operand1);
    assert(PyLong_CheckExact(operand1));
...
nuitka_bool BINARY_OPERATION_RSHIFT_NBOOL_LONG_CLONG(PyObject *operand1, long operand2) {
    return _BINARY_OPERATION_RSHIFT_NBOOL_LONG_CLONG(operand1, operand2);
}

/* Code referring to "CLONG" corresponds to C platform long value and "LONG" to Python2 'long', Python3 'int'. */
static nuitka_bool _BINARY_OPERATION_RSHIFT_NBOOL_CLONG_LONG(long operand1, PyObject *operand2) {
...
nuitka_bool BINARY_OPERATION_RSHIFT_NBOOL_CLONG_LONG(long operand1, PyObject *operand2) {
    return _BINARY_OPERATION_RSHIFT_NBOOL_CLONG_LONG(operand1, operand2);
}
