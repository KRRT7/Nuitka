...
static PyObject *_BINARY_OPERATION_BITXOR_OBJECT_OBJECT_OBJECT(PyObject *operand1, PyObject *operand2) {
    ...
    if (PyLong_CheckExact(operand1) && PyLong_CheckExact(operand2)) {
        return BINARY_OPERATION_BITXOR_OBJECT_LONG_LONG(operand1, operand2);
    }
#endif
#if PYTHON_VERSION < 0x300
 ...
 * Python objects. */
static PyObject *_BINARY_OPERATION_BITXOR_OBJECT_LONG_DIGIT(PyObject *operand1, long operand2) {
    CHECK_OBJECT(operand1);
    assert(PyLong_CheckExact(operand1));
...
PyObject *BINARY_OPERATION_BITXOR_OBJECT_LONG_DIGIT(PyObject *operand1, long operand2) {
    return _BINARY_OPERATION_BITXOR_OBJECT_LONG_DIGIT(operand1, operand2);
}

/* Code referring to "LONG" corresponds to Python2 'long', Python3 'int' and "DIGIT" to C platform digit value for long
 * Python objects. */
static nuitka_bool _BINARY_OPERATION_BITXOR_NBOOL_LONG_DIGIT(PyObject *operand1, long operand2) {
    CHECK_OBJECT(operand1);
    assert(PyLong_CheckExact(operand1));
    assert(Py_ABS(operand2) < (1 << PyLong_SHIFT));
...
nuitka_bool BINARY_OPERATION_BITXOR_NBOOL_LONG_DIGIT(PyObject *operand1, long operand2) {
    return _BINARY_OPERATION_BITXOR_NBOOL_LONG_DIGIT(operand1, operand2);
}

/* Code referring to "LONG" corresponds to Python2 'long', Python3 'int' and "CLONG" to C platform long value. */
static PyObject *_BINARY_OPERATION_BITXOR_OBJECT_LONG_CLONG(PyObject *operand1, long operand2) {
    CHECK_OBJECT(operand1);
    assert(PyLong_CheckExact(operand1));
...
PyObject *BINARY_OPERATION_BITXOR_OBJECT_LONG_CLONG(PyObject *operand1, long operand2) {
    return _BINARY_OPERATION_BITXOR_OBJECT_LONG_CLONG(operand1, operand2);
}

/* Code referring to "LONG" corresponds to Python2 'long', Python3 'int' and "CLONG" to C platform long value. */
static nuitka_bool _BINARY_OPERATION_BITXOR_NBOOL_LONG_CLONG(PyObject *operand1, long operand2) {
    CHECK_OBJECT(operand1);
    assert(PyLong_CheckExact(operand1));
...
nuitka_bool BINARY_OPERATION_BITXOR_NBOOL_LONG_CLONG(PyObject *operand1, long operand2) {
    return _BINARY_OPERATION_BITXOR_NBOOL_LONG_CLONG(operand1, operand2);
}
