...
#pragma warning(pop)
        ...
        obj_result = BINARY_OPERATION_MOD_OBJECT_OBJECT_OBJECT(operand1->python_value, operand2_object);
    ...
    exit_result_ok_clong:
        ...
        PyObject *operand2_object = Nuitka_PyLong_FromLong(operand2);
        PyObject *python_result = BINARY_OPERATION_MOD_OBJECT_OBJECT_OBJECT(operand1->python_value, operand2_object);
        Py_DECREF(operand2_object);
...
#pragma warning(pop)
        ...
        obj_result = BINARY_OPERATION_MOD_OBJECT_OBJECT_OBJECT(operand1_object, operand2->python_value);
    ...
    exit_result_ok_clong:
        ...
        PyObject *operand1_object = Nuitka_PyLong_FromLong(operand1);
        PyObject *python_result = BINARY_OPERATION_MOD_OBJECT_OBJECT_OBJECT(operand1_object, operand2->python_value);
        Py_DECREF(operand1_object);
