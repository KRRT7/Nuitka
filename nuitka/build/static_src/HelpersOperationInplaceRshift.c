 ...
 * Python objects. */
static inline bool _INPLACE_OPERATION_RSHIFT_LONG_DIGIT(PyObject **operand1, long operand2) {
    assert(operand1); // Pointer must be non-null.
...
bool INPLACE_OPERATION_RSHIFT_LONG_DIGIT(PyObject **operand1, long operand2) {
    return _INPLACE_OPERATION_RSHIFT_LONG_DIGIT(operand1, operand2);
}

/* Code referring to "LONG" corresponds to Python2 'long', Python3 'int' and "CLONG" to C platform long value. */
static inline bool _INPLACE_OPERATION_RSHIFT_LONG_CLONG(PyObject **operand1, long operand2) {
    assert(operand1); // Pointer must be non-null.
...
bool INPLACE_OPERATION_RSHIFT_LONG_CLONG(PyObject **operand1, long operand2) {
    return _INPLACE_OPERATION_RSHIFT_LONG_CLONG(operand1, operand2);
}
